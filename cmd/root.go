...
var rootCmd = &cobra.Command{
	Use:   "tracker",
	Short: "simple cli for tracking things",
	Long:  "simple cli for tracking things",
...
func initConfig() {
	...
	if err := viper.ReadInConfig(); err != nil {
		logrus.Errorf("error reading config: %s", err)
		logrus.Infof("if file isn't found, try running 'tracker setup'")
	}
